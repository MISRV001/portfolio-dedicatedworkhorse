	...
	if($currentDepartment == 10){$classDeptName = "shop"; echo "<div id='menuItem'> <div id='" . $classDeptName . "Bar' class='colapsedMenu'>s<br />h<br />o<br />p<br />&nbsp;<br />g<br />u<br />y<br />s<br /></div> <div id='" . $classDeptName . "Content' class='floatL'>";}
		...
		while($days_in_month >= $day_num) {
			...
			while($cols <= $num_stake) {
				...
				echo "<td id=\"".$colname."\" style=\"width:125px\"><a class=\"iframe\" style=\"display:block;width:100%;\" href=\"editcol.php?editSelector=".$colname."\">".$colname."</a></td>"; 
				$cols++;
			}

			//echo "<td class=\"addblock\" style=\"width:125px\"><a class=\"iframe\" style=\"display:block;width:100%;\" href=\"editcol.php?editSelector=".$colname."\">".$colname."</a></td>"; 
			echo "</tr>";
			$day_num++;	
			$cols = 1;
		}
